...
DEFAULT_TYPE_RULES: Mapping[str, ColumnType] = {
    ...
    "UPC": ColumnType.TEXT,
    "RollNo": ColumnType.TEXT,
    "VtgNo": ColumnType.TEXT,
    "VCollection": ColumnType.TEXT,
    "Collection": ColumnType.TEXT,
    "VDesign": ColumnType.TEXT,
    "Design": ColumnType.TEXT,
    "Brand": ColumnType.TEXT,
    "Ground": ColumnType.TEXT,
    "Border": ColumnType.TEXT,
    "ASize": ColumnType.TEXT,
    "SSize": ColumnType.TEXT,
    "Area": ColumnType.NUMBER,
    "Type": ColumnType.TEXT,
    "Rate": ColumnType.NUMBER,
    "Amount": ColumnType.NUMBER,
    "Shape": ColumnType.TEXT,
    "Style": ColumnType.TEXT,
    "ImageFileName": ColumnType.TEXT,
    "Origin": ColumnType.TEXT,
    "Retail": ColumnType.NUMBER,
    "SP": ColumnType.NUMBER,
    "MSRP": ColumnType.NUMBER,
    "Cost": ColumnType.NUMBER,
    "Status": ColumnType.TEXT,
    "Qty": ColumnType.INTEGER,
    "Consignment": ColumnType.TEXT,
